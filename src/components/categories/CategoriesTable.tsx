...
import type { CategoryWithCountsRow, CategoryType } from "@/lib/types";
...
type SortField = "name" | "type" | "ruleCount" | "transactionCount";
...
export default function CategoriesTable() {
  ...
  async function updateCategory(id: number, updates: { name?: string; type?: CategoryType }) {
    setError(null);
    try {
...
function CategoryRow({
  ...
  onUpdate: (updates: { name?: string; type?: CategoryType }) => void;
  onDelete: () => void;
}) {
